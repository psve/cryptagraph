...
sbox_8              The 8-bit S-box
sbox_4              The 4-bit S-box
table_64            The 64-bit permutation
table_d             The 4-bit matrix multiplication
table_4             The 4-bit permutation
table_128           The 128-bit permutation
*/
#[derive(Clone)]
pub struct Iceberg {
    size: usize,
