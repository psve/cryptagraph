...
impl Skinny128 {
    ...
    pub fn new() -> Skinny128 {
        ...
        let itable = vec![
            ,
        ];
...
mod tests {
    ...
    fn encryption_test() {
        let cipher = cipher::name_to_cipher("skinny128").unwrap();
        let key = [
            0x93, 0x3e, 0x07, 0x37, 0x5f, 0xc1, 0x92, 0xfd, 0x52, 0xac, 0x0c, 0x52, 0xb0, 0xcf,
            0x55, 0x4f,
        ];
        ...
        let key = [
            0xc8, 0x9e, 0x97, 0xaa, 0x40, 0xc6, 0x8d, 0x2a, 0xad, 0xe5, 0x89, 0x50, 0x22, 0xb7,
            0x2b, 0x1c,
        ];
        let round_keys = cipher.key_schedule(40, &key);
