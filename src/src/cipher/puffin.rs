...
impl Puffin {
    ...
    const KEY_PERMUTATION: [u128; 128] = [
        22, 121, 126, 110, 79, 81, 116, 55, 113, 21, 29, 20, 56, 76, 41, 112, 45, 109, 95, 87, 94,
        44, 68, 8, 115, 69, 6, 75, 83, 5, 54, 70, 23, 61, 106, 103, 85, 124, 111, 52, 119, 32, 100,
        17, 15, 34, 128, 91, 58, 99, 120, 67, 31, 98, 53, 71, 92, 25, 38, 93, 65, 2, 37, 28, 24,
        82, 88, 14, 96, 118, 1, 9, 125, 27, 127, 18, 4, 10, 102, 7, 35, 105, 48, 63, 30, 77, 72,
        50, 108, 73, 12, 19, 107, 11, 26, 84, 47, 97, 117, 49, 46, 33, 16, 42, 39, 57, 114, 62,
        123, 101, 80, 13, 51, 122, 64, 89, 43, 60, 40, 3, 86, 90, 59, 74, 78, 104, 36, 66,
    ];
    const KEY_SELECTION: [u128; 64] = [
        3, 123, 15, 58, 89, 36, 98, 52, 57, 63, 100, 70, 46, 71, 94, 51, 83, 14, 4, 22, 32, 114,
        84, 101, 12, 23, 31, 65, 41, 96, 120, 50, 45, 54, 112, 122, 29, 81, 30, 121, 97, 55, 26,
        64, 24, 117, 19, 9, 111, 18, 44, 86, 16, 95, 42, 72, 2, 91, 118, 124, 38, 48, 43, 39,
    ];
