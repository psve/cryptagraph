...
pub struct CliArgs {
    ...
    #[structopt(short = "l", long = "last", help = "Number of patterns to generate for the last round.")]
    pub last_round_limit: Option<usize>,

    #[structopt(short = "a", long = "approximations", help = "Number of single round approximations to generate.")]
    pub approximation_limit: Option<usize>,
