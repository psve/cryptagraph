 ...
 *
 * sorted_alphas    Alpha approximations to use.
 * false_positive   False positive rate for Bloom filters.
 */
fn create_alpha_filter(sorted_alphas: &SortedApproximations, 
                       false_positive: f64) -> BloomFilter {
...
fn create_backward_filters
    ...
    let mut sorted_alphas = approximation.clone();
